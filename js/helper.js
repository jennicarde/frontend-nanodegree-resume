...
*/
var HTMLheaderName = '<h1 id="name">%data%</h1>';
var HTMLheaderRole = '<span class="role-text">%data%</span>';
...
var HTMLtwitter = '<li class="flex-item"><span class="contact-type">twitter</span><span class="white-text">%data%</span></li>';
var HTMLgithub = '<li class="flex-item"><span class="contact-type">github</span><span class="white-text">%data%</span></li>';
var HTMLblog = '<li class="flex-item"><span class="ocontact-type">blog</span><span class="white-text">%data%</span></li>';
var HTMLlocation = '<li class="flex-item"><span class="contact-type">location</span><span class="white-text">%data%</span></li>';
...
var HTMLskillsStart = '<h3 id="skills-h3">Skills at a Glance:</h3><ul id="skills" class="flex-column"></ul>';
var HTMLskills = '<li class="flex-item skill"><span class="pink">%data%</span></li>';
...
// Added Certificates
var HTMLcertificates = '<h3 class="online-text">Certificates</h3>';
var HTMLcertificatesName = '<a href="#">%data%';
var HTMLcertificatesDates = '<div class="date-text">%data%</div>';
var HTMLcertificatesLocation = '<div class="location-text">%data%</div>';
var HTMLcertificatesMajor = '<em><br>Certificate: %data%</em>';

var HTMLonlineClasses = '<h3 class="online-text">Online Classes</h3>';
var HTMLonlineTitle = '<a href="#">%data%';
var HTMLonlineSchool = ' - %data%</a>';
var HTMLonlineDates = '<div class="date-text">%data%</div>';
var HTMLonlineURL = '<br><a href="#">%data%</a>';
